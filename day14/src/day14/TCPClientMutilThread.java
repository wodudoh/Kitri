...
//				int readI = dis.readInt();
				...
				System.out.println("서버측에서 보내준 자료 : " + ", " + readS);
			} while (true);
...
//			dos.writeUTF("오재영. HELLO");
			...
			/*
			 * for(int i=1; i<=10;i++){ dos.writeInt(i); dos.writeUTF("HELLO");
			 * }
			 */
...
//				i++;
				...
				/*
				 * int readI = dis.readInt(); String readS = dis.readUTF();
