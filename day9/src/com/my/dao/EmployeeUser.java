...
public class EmployeeUser {
	...
	public void findAll() {
		...
		for (int i = 0; i < arr.length; i++) {
			/*
			 * println(Object x ){ String.Value(x); }
			 *
			 *
			 * valueOf(Object obj){ obj.toString( ); }
			 */
			System.out.println(arr[i]); // TODO 일반사원인 경우는 "일반사원:사번값:이름값:급여값"이
										// 출력되고
										// 관리자인 경우는 "관리자:사번값:이름값:급여값:수당값"이 출력되도록
										// 한다.
										// 현재코드는 변경하지 않는다
		}
	}
